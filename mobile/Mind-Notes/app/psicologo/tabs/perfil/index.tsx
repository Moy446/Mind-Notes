import { View, Text, Image, Modal, TouchableOpacity, Alert, Pressable } from 'react-native'
  ...
  return (
    <View style={perfilStyle.container}>
      <View style={perfilStyle.title}>
        ...
        <Pressable style={perfilStyle.logoutContainer} onPress={salir}>
          <Svg
            viewBox="0 0 24 24"
            width={40}
            height={40}
          ...
          <Text style={perfilStyle.redText}> Cerrar sesión </Text>
        </Pressable>
      </View>
      ...
      <Pressable style={perfilStyle.deleteContainer} onPress={() => setShowPopup(true)}>
        <Svg
          viewBox="0 0 24 24"
          width={40}
          height={40}
        ...
        <Text style={perfilStyle.redText}>Eliminar cuenta</Text>
      </Pressable>
